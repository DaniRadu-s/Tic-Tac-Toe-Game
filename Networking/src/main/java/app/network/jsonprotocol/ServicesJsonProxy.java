...
public class ServicesJsonProxy implements IServices {
    ...
    public void addGame(Game game) throws AppException {
    ...
    public void addPosition(Position game) throws AppException {
        Request request = JsonProtocolUtils.createAddPositionRequest(game);
        sendRequest(request);
        Response response = readResponse();
        if (response.getType() == ResponseType.ERROR) {
            String err = response.getErrorMessage();
    ...
    public List<Position> getAllPositions() throws AppException {
        Request request = JsonProtocolUtils.createGetAllPositionsRequest();
        sendRequest(request);
        Response response = readResponse();
        if (response.getType() == ResponseType.ERROR) {
            String err = response.getErrorMessage();
    ...
    public void logout(Player player, IObserver client) throws AppException {
