...
public class JsonProtocolUtils {
    ...
    public static Response createGetAllPositionsResponse(List<Position> games) {
        Response response = new Response();
        response.setType(ResponseType.GET_POSITIONS);
        response.setPositions(games);
        return response;
    }
    ...
    public static Request createAddPositionRequest(Position game) {
        Request request = new Request();
        request.setType(RequestType.ADD_POSITION);
        request.setPosition(game);
        return request;
    }
    ...
    public static Request createGetAllPositionsRequest() {
        Request request = new Request();
        request.setType(RequestType.GET_POSITIONS);
        return request;
    }
